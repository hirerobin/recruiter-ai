...
async function runScoring(ctx: BotContext): Promise<void> {
  ...
  if (passed && env.PUBLIC_URL) {
    ...
    await ctx.reply(
      l === 'id'
        ? '🎙 *Langkah berikutnya: AI Interview*\n\nSelamat! Anda akan melanjutkan ke sesi interview singkat bersama AI kami (sekitar 5–10 menit). Jawaban Anda pada sesi ini akan menjadi penilaian utama untuk menentukan kelanjutan proses rekrutmen Anda.\n\n⚠️ *Perhatian penting sebelum memulai:*\n• Cari tempat yang *tenang dan minim kebisingan* — suara bising dapat memengaruhi hasil interview Anda\n• Pastikan koneksi internet Anda stabil\n• Gunakan headset atau earphone jika tersedia\n• Berbicara dengan jelas, tidak terburu-buru\n• Jawab setiap pertanyaan dengan jujur dan lengkap\n\nSiap? Tekan tombol di bawah untuk memulai. 👇'
        : '🎙 *Next step: AI Interview*\n\nCongratulations! You will now proceed to a short AI interview session (approximately 5–10 minutes). Your answers in this session will be the primary factor in determining the next stage of your recruitment.\n\n⚠️ *Important before you start:*\n• Find a *quiet place with minimal background noise* — noise can affect your interview results\n• Make sure your internet connection is stable\n• Use a headset or earphone if available\n• Speak clearly and at a steady pace\n• Answer each question honestly and completely\n\nReady? Tap the button below to begin. 👇',
